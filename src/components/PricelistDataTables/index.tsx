...
const col = ["id", "code", "name", "price"];

export const PricelistDataTables = () => {
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(setPageTitle("Pricelist"));
  });
  ...
  const [initialRecords, setInitialRecords] = useState<Pricelist[]>([]);
      ...
      setInitialRecords(() => {
        return result.filter((item: any) => {
          return (
            ...
            item.package_details.toLowerCase().includes(search.toLowerCase()) ||
  ...
  const header = ["Id", "Code", "Name", "Price", "Status", "Action"];

  const formmatDate = (date: any) => {
    if (date) {
        ...
        <div className="datatables">
          <DataTable
            ...
            columns={[
              ...
              { accessor: "package_details", sortable: true },
              // {
              //   accessor: "created_at",
              //   title: "Start Date",
              //   sortable: true,
              //   render: ({ created_at }) => (
              //     <div>{formmatDate(created_at)}</div>
              //   ),
              // },
              {
                accessor: "isActive",
...
export default PricelistDataTables;
