            ...
            <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <li className="menu nav-item">
                <button
                  type="button"
                  className={`${
                    currentMenu === "pricelist" ? "active" : ""
                  } nav-link group w-full`}
                  onClick={() => toggleMenu("pricelist")}
                >
                  <div className="flex items-center">
                    <svg
                      className="group-hover:!text-primary"
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "pricelist" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
              ...
              <li className="menu nav-item">
                <button
                  type="button"
                  className={`${
                    currentMenu === "transaction" ? "active" : ""
                  } nav-link group w-full`}
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "transaction" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/apps/transaction/list">{t("list")}</Link>
                    </li>
                    <li>
                      <Link href="/apps/transaction/add">{t("add")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
              ...
              <li className="menu nav-item">
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "expense" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/apps/expense/category">{t("category")}</Link>
                    </li>
                    <li>
                      <Link href="/apps/expense/list">{t("list")}</Link>
                    </li>
                    <li>
                      <Link href="/apps/expense/add">{t("add")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
              ...
              <li className="menu nav-item">
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu === "account" ? "rotate-90" : "rtl:rotate-180"
                    }
                  >
                    <svg
                      width="16"
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "account" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/accounting/account/list">{t("list")}</Link>
                    </li>
                    <li>
                      <Link href="/accounting/account/add">{t("add")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
              ...
              <li className="menu nav-item">
                <Link href="/accounting/account-statement" className="group">
                  <div className="flex items-center">
                    <svg
                      className="group-hover:!text-primary"
                      width="20"
              ...
              <li className="menu nav-item">
                <Link href="/accounting/money-transfer" className="group">
                  <div className="flex items-center">
                    <svg
                      className="group-hover:!text-primary"
                      width="20"
              ...
              <li className="menu nav-item">
                <Link href="/accounting/balance-sheet" className="group">
                  <div className="flex items-center">
                    <svg
                      className="group-hover:!text-primary"
                      width="20"
              ...
              <li className="menu nav-item">
                <button
                  type="button"
                  className={`${
                    currentMenu === "debts-and-receivables" ? "active" : ""
                  } nav-link group w-full`}
                  onClick={() => toggleMenu("debts-and-receivables")}
                >
                  <div className="flex items-center">
                    <svg
                      className="group-hover:!text-primary"
                    ...
                    <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                      {t("debts-and-receivables")}
                    </span>
                  </div>

                  <div
                    className={
                      currentMenu === "debts-and-receivables"
                        ? "rotate-90"
                        : "rtl:rotate-180"
                    }
                  >
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "debts-and-receivables" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/accounting/debts-and-receivables/debts">
                        {t("debts")}
                      </Link>
                    </li>
                    <li>
                      <Link href="/accounting/debts-and-receivables/receivables">
                        {t("receivables")}
                      </Link>
                    </li>
                  </ul>
              ...
              <li className="menu nav-item">
                ...
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/entity/users/list">{t("list")}</Link>
                    </li>
                    <li>
                      <Link href="/entity/users/add">{t("add")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
              ...
              <li className="menu nav-item">
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "customer" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/entity/customer/list">{t("list")}</Link>
                    </li>
                    <li>
                      <Link href="/entity/customer/add">{t("add")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
              ...
              <li className="menu nav-item">
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu === "vendor" ? "rotate-90" : "rtl:rotate-180"
                    }
                  >
                    <svg
                      width="16"
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "vendor" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/entity/vendor/list">{t("list")}</Link>
                    </li>
                    <li>
                      <Link href="/entity/vendor/add">{t("add")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
              ...
              <li className="menu nav-item">
                <button type="button" className="nav-link group">
                  <Link href="/reports/summary-report" className="group">
                    <div className="flex items-center">
                      <svg
                        className="group-hover:!text-primary"
                        width="20"
              ...
              <li className="menu nav-item">
                <button
                  type="button"
                  className={`${
                    currentMenu === "transaction-report" ? "active" : ""
                  } nav-link group w-full`}
                  onClick={() => toggleMenu("transaction-report")}
                >
                  <div className="flex items-center">
                    <svg
                      className="group-hover:!text-primary"
                  ...
                  <div
                    className={
                      currentMenu === "transaction-report"
                        ? "rotate-90"
                        : "rtl:rotate-180"
                    }
                  >
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "transaction-report" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/reports/transaction-report/daily-transaction">
                        {t("daily-transaction")}
                      </Link>
                    </li>
                    <li>
                      <Link href="/reports/transaction-report/monthly-transaction">
                        {t("monthly-transaction")}
                      </Link>
                    </li>
                    <li>
                      <Link href="/reports/transaction-report/sale-report">
                        {t("sale-report")}
                      </Link>
                    </li>
                  </ul>
