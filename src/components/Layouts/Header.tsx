  ...
  return (
    ...
    >
      <div className="shadow-sm">
        <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
          <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
            <Link href="/" className="main-logo flex shrink-0 items-center">
              <img
                ...
                alt="logo"
              />
              <span className="dark:text-white-light hidden align-middle  text-2xl  font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 md:inline">
                VRISTO
              </span>
            </Link>
            <button
          ...
          <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
            <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
              ...
              >
                <div className="relative">
                  <input
                    type="text"
                    className="form-input peer bg-gray-100 placeholder:tracking-widest ltr:pl-9 ltr:pr-9 rtl:pl-9 rtl:pr-9 sm:bg-transparent ltr:sm:pr-4 rtl:sm:pl-4"
                    placeholder="Search..."
                  />
                  <button
                    type="button"
              ...
              >
                <svg
                  className="h-4.5 w-4.5 mx-auto dark:text-[#d0d2d6]"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="dropdown shrink-0">
              ...
              >
                <ul className="text-dark dark:text-white-dark w-[300px] divide-y !py-0 dark:divide-white/10 sm:w-[350px]">
                  <li onClick={(e) => e.stopPropagation()}>
        ...
        {/* horizontal menu */}
        <ul className="horizontal-menu dark:text-white-dark hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black lg:space-x-1.5 xl:space-x-8">
