          ...
          <div className="panel h-full">
            ...
            <PerfectScrollbar className="perfect-scrollbar relative -mr-3 h-[360px] pr-3">
              <div className="space-y-7">
                <div className="flex">
                  <div className="relative z-10 before:absolute before:left-4 before:top-10 before:h-[calc(100%-24px)] before:w-[2px] before:bg-white-dark/30 ltr:mr-2 rtl:ml-2">
              ...
              <div className="absolute bottom-0 -mx-5 flex w-full items-center justify-between p-5">
                <div className="flex items-center">
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="relative -top-1 inline text-info ltr:mr-1.5 rtl:ml-1.5"
                  >
                    <path
                ...
                >
                  ...
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 ltr:ml-1.5 rtl:mr-1.5 rtl:rotate-180"
                  >
                    <path
                      d="M11 19L17 12L11 5"
                      stroke="currentColor"
